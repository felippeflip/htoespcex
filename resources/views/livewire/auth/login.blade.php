<x-layouts.auth>
    <div class="flex flex-col gap-6">
        <x-auth-header :title="__('Entre na sua conta')" :description="__('Digite seu e-mail e senha abaixo para entrar')" />
        ...
        <form method="POST" action="{{ route('login.store') }}" class="flex flex-col gap-6">
            ...
            <!-- Email Address -->
            <flux:input name="email" :label="__('Endereço de e-mail')" :value="old('email')" type="email" required
                autofocus autocomplete="email" placeholder="email@exemplo.com" />
