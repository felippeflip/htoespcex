            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-gray-100 p-4 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-gray-900">R$ {{ number_format($totalAmount, 2, ',', '.') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-yellow-100 p-4 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-yellow-900">R$ {{ number_format($totalPending, 2, ',', '.') }}
                        </p>
                    </div>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($payments as $payment)
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                            {{ $payment->nome_contribuinte }}<br>
                                                            <span class="text-xs text-gray-400">{{ $payment->cnpj_cpf }}</span>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <span
                                                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                                                                                    {{ $payment->status === 'Concluído' ? 'bg-green-100 text-green-800' :
