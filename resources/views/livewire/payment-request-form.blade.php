        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" wire:model="cnpj_cpf" id="cnpj_cpf"
                    ...
                    <div>
                        <label for="nome_contribuinte" class="block text-sm font-medium text-gray-700">Nome do
                            Contribuinte</label>
                        <input type="text" wire:model="nome_contribuinte" id="nome_contribuinte"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            ...
            <div class="col-span-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <label for="valor_principal" class="block text-sm font-medium text-gray-700">Valor Principal
                            (R$)</label>
                        <input type="number" step="0.01" wire:model="valor_principal" id="valor_principal"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        @error('valor_principal') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label for="valor_descontos" class="block text-sm font-medium text-gray-700">Descontos
                            (R$)</label>
                        <input type="number" step="0.01" wire:model="valor_descontos" id="valor_descontos"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        @error('valor_descontos') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label for="valor_outras_deducoes" class="block text-sm font-medium text-gray-700">Outras
                            Deduções (R$)</label>
                        <input type="number" step="0.01" wire:model="valor_outras_deducoes" id="valor_outras_deducoes"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        @error('valor_outras_deducoes') <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>

                    <div>
                        <label for="valor_multa" class="block text-sm font-medium text-gray-700">Multa (R$)</label>
                        <input type="number" step="0.01" wire:model="valor_multa" id="valor_multa"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" wire:model="valor_juros" id="valor_juros"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        @error('valor_juros') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label for="valor_outros_acrescimos" class="block text-sm font-medium text-gray-700">Outros
                            Acréscimos (R$)</label>
                        <input type="number" step="0.01" wire:model="valor_outros_acrescimos"
                            id="valor_outros_acrescimos"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        @error('valor_outros_acrescimos') <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
            </div>
